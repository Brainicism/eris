    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_MEMBER_ADD": {
                ...
                ++guild.memberCount;
                let member = null;
                if(packet.d.id === this.client.user.id) member = guild.members.add(packet.d, guild);
                /**
                ...
                * @prop {Member} member The member
                */
                this.emit("guildMemberAdd", guild, member || new Member(packet.d, guild, this.client));
                break;
            }
            case "GUILD_MEMBER_UPDATE": {
                ...
                member = new Member(packet.d, guild, this.client);//guild.members.update(packet.d, guild);
                /**
